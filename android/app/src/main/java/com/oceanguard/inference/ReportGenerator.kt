...
class ReportGenerator(
    ...
    companion object {
        ...
        private val MATERIAL_NAMES: Map<String, Map<String, String>> = mapOf(
            "en" to mapOf("PLASTIC" to "Plastic", "FISHING_NET" to "Fishing Net", "RUBBER" to "Rubber", "METAL" to "Metal", "GLASS" to "Glass", "FABRIC" to "Fabric", "WOOD" to "Wood", "PAPER" to "Paper", "CERAMIC" to "Ceramic", "CHEMICAL" to "Hazardous Chemical"),
            "es" to mapOf("PLASTIC" to "Plástico", "FISHING_NET" to "Red de pesca", "RUBBER" to "Caucho", "METAL" to "Metal", "GLASS" to "Vidrio", "FABRIC" to "Tela", "WOOD" to "Madera", "PAPER" to "Papel", "CERAMIC" to "Ceramica", "CHEMICAL" to "Quimico peligroso"),
            "fr" to mapOf("PLASTIC" to "Plastique", "FISHING_NET" to "Filet de pêche", "RUBBER" to "Caoutchouc", "METAL" to "Métal", "GLASS" to "Verre", "FABRIC" to "Tissu", "WOOD" to "Bois", "PAPER" to "Papier", "CERAMIC" to "Ceramique", "CHEMICAL" to "Produit chimique dangereux"),
            "de" to mapOf("PLASTIC" to "Plastik", "FISHING_NET" to "Fischernetz", "RUBBER" to "Gummi", "METAL" to "Metall", "GLASS" to "Glas", "FABRIC" to "Stoff", "WOOD" to "Holz", "PAPER" to "Papier", "CERAMIC" to "Keramik", "CHEMICAL" to "Gefahrstoff"),
            "it" to mapOf("PLASTIC" to "Plastica", "FISHING_NET" to "Rete da pesca", "RUBBER" to "Gomma", "METAL" to "Metallo", "GLASS" to "Vetro", "FABRIC" to "Tessuto", "WOOD" to "Legno", "PAPER" to "Carta", "CERAMIC" to "Ceramica", "CHEMICAL" to "Chimico pericoloso"),
            "pt" to mapOf("PLASTIC" to "Plástico", "FISHING_NET" to "Rede de pesca", "RUBBER" to "Borracha", "METAL" to "Metal", "GLASS" to "Vidro", "FABRIC" to "Tecido", "WOOD" to "Madeira", "PAPER" to "Papel", "CERAMIC" to "Ceramica", "CHEMICAL" to "Quimico perigoso"),
        )

        // ---- i18n: Debris type display names per language ----
        private val TYPE_NAMES: Map<String, Map<String, String>> = mapOf(
            "en" to mapOf(
                "PLASTIC_DEBRIS" to "Plastic Debris", "FISHING_NET" to "Fishing Net", "TIRE" to "Tire", "BOTTLE" to "Bottle", "CAN" to "Can", "MASK" to "Mask", "GLOVE" to "Glove", "METAL_DEBRIS" to "Metal Debris",
                "BOTTLE_CAP" to "Bottle Cap", "PLASTIC_BAG" to "Plastic Bag", "FOOD_WRAPPER" to "Food Wrapper", "STYROFOAM" to "Styrofoam", "PLASTIC_CUP" to "Plastic Cup", "STRAW" to "Straw", "PLASTIC_UTENSIL" to "Plastic Utensil", "SIX_PACK_RING" to "Six-Pack Ring", "PLASTIC_SHEETING" to "Plastic Sheeting", "DIAPER" to "Diaper", "CIGARETTE_BUTT" to "Cigarette Butt", "CIGARETTE_LIGHTER" to "Lighter", "FISHING_LINE" to "Fishing Line", "ROPE" to "Rope", "FISHING_BUOY" to "Fishing Buoy", "FISHING_TRAP" to "Fishing Trap", "AEROSOL_CAN" to "Aerosol Can", "METAL_DRUM" to "Metal Drum", "WIRE_CABLE" to "Wire/Cable", "BATTERY" to "Battery", "ELECTRONICS" to "Electronics", "GLASS_BOTTLE" to "Glass Bottle", "GLASS_JAR" to "Glass Jar", "GLASS_FRAGMENT" to "Glass Fragment", "LIGHT_BULB" to "Light Bulb", "FLIP_FLOP" to "Flip-Flop", "RUBBER_HOSE" to "Rubber Hose", "CLOTHING" to "Clothing", "SHOE" to "Shoe", "CARDBOARD" to "Cardboard", "PAPER" to "Paper", "WOOD_PALLET" to "Wood Pallet", "LUMBER" to "Lumber", "CERAMIC_FRAGMENT" to "Ceramic Fragment", "BRICK" to "Brick/Concrete", "PAINT_CAN" to "Paint Can", "OIL_CONTAINER" to "Oil Container", "SYRINGE" to "Syringe", "CHEMICAL_DRUM" to "Chemical Drum", "FABRIC_DEBRIS" to "Fabric Debris", "GLASS_DEBRIS" to "Glass Debris",
            ),
            "es" to mapOf(
                "PLASTIC_DEBRIS" to "Residuos plásticos", "FISHING_NET" to "Red de pesca", "TIRE" to "Neumático", "BOTTLE" to "Botella", "CAN" to "Lata", "MASK" to "Mascarilla", "GLOVE" to "Guante", "METAL_DEBRIS" to "Residuos metálicos",
                "BOTTLE_CAP" to "Tapon", "PLASTIC_BAG" to "Bolsa de plastico", "FOOD_WRAPPER" to "Envoltorio de comida", "STYROFOAM" to "Poliestireno", "PLASTIC_CUP" to "Vaso de plastico", "STRAW" to "Pajita", "PLASTIC_UTENSIL" to "Cubierto de plastico", "SIX_PACK_RING" to "Anilla de latas", "PLASTIC_SHEETING" to "Lamina de plastico", "DIAPER" to "Panal", "CIGARETTE_BUTT" to "Colilla", "CIGARETTE_LIGHTER" to "Mechero", "FISHING_LINE" to "Sedal", "ROPE" to "Cuerda", "FISHING_BUOY" to "Boya de pesca", "FISHING_TRAP" to "Trampa de pesca", "AEROSOL_CAN" to "Aerosol", "METAL_DRUM" to "Bidon metalico", "WIRE_CABLE" to "Cable/Alambre", "BATTERY" to "Pila", "ELECTRONICS" to "Electronico", "GLASS_BOTTLE" to "Botella de vidrio", "GLASS_JAR" to "Tarro de vidrio", "GLASS_FRAGMENT" to "Fragmento de vidrio", "LIGHT_BULB" to "Bombilla", "FLIP_FLOP" to "Chancla", "RUBBER_HOSE" to "Manguera de goma", "CLOTHING" to "Ropa", "SHOE" to "Zapato", "CARDBOARD" to "Carton", "PAPER" to "Papel", "WOOD_PALLET" to "Palet de madera", "LUMBER" to "Tabla de madera", "CERAMIC_FRAGMENT" to "Fragmento ceramico", "BRICK" to "Ladrillo/Hormigon", "PAINT_CAN" to "Bote de pintura", "OIL_CONTAINER" to "Bidon de aceite", "SYRINGE" to "Jeringuilla", "CHEMICAL_DRUM" to "Bidon quimico", "FABRIC_DEBRIS" to "Residuos textiles", "GLASS_DEBRIS" to "Residuos de vidrio",
            ),
            "fr" to mapOf(
                "PLASTIC_DEBRIS" to "Débris plastiques", "FISHING_NET" to "Filet de pêche", "TIRE" to "Pneu", "BOTTLE" to "Bouteille", "CAN" to "Canette", "MASK" to "Masque", "GLOVE" to "Gant", "METAL_DEBRIS" to "Débris métalliques",
                "BOTTLE_CAP" to "Bouchon", "PLASTIC_BAG" to "Sac en plastique", "FOOD_WRAPPER" to "Emballage alimentaire", "STYROFOAM" to "Polystyrene", "PLASTIC_CUP" to "Gobelet en plastique", "STRAW" to "Paille", "PLASTIC_UTENSIL" to "Couvert en plastique", "SIX_PACK_RING" to "Anneau de canettes", "PLASTIC_SHEETING" to "Film plastique", "DIAPER" to "Couche", "CIGARETTE_BUTT" to "Megot", "CIGARETTE_LIGHTER" to "Briquet", "FISHING_LINE" to "Fil de peche", "ROPE" to "Corde", "FISHING_BUOY" to "Bouee de peche", "FISHING_TRAP" to "Casier de peche", "AEROSOL_CAN" to "Aerosol", "METAL_DRUM" to "Fut metallique", "WIRE_CABLE" to "Fil/Cable", "BATTERY" to "Pile", "ELECTRONICS" to "Electronique", "GLASS_BOTTLE" to "Bouteille en verre", "GLASS_JAR" to "Pot en verre", "GLASS_FRAGMENT" to "Fragment de verre", "LIGHT_BULB" to "Ampoule", "FLIP_FLOP" to "Tong", "RUBBER_HOSE" to "Tuyau en caoutchouc", "CLOTHING" to "Vetement", "SHOE" to "Chaussure", "CARDBOARD" to "Carton", "PAPER" to "Papier", "WOOD_PALLET" to "Palette en bois", "LUMBER" to "Planche de bois", "CERAMIC_FRAGMENT" to "Fragment ceramique", "BRICK" to "Brique/Beton", "PAINT_CAN" to "Pot de peinture", "OIL_CONTAINER" to "Bidon d'huile", "SYRINGE" to "Seringue", "CHEMICAL_DRUM" to "Fut chimique", "FABRIC_DEBRIS" to "Debris textiles", "GLASS_DEBRIS" to "Debris de verre",
            ),
            "de" to mapOf(
                "PLASTIC_DEBRIS" to "Plastikmüll", "FISHING_NET" to "Fischernetz", "TIRE" to "Reifen", "BOTTLE" to "Flasche", "CAN" to "Dose", "MASK" to "Maske", "GLOVE" to "Handschuh", "METAL_DEBRIS" to "Metallabfall",
                "BOTTLE_CAP" to "Flaschendeckel", "PLASTIC_BAG" to "Plastiktute", "FOOD_WRAPPER" to "Lebensmittelverpackung", "STYROFOAM" to "Styropor", "PLASTIC_CUP" to "Plastikbecher", "STRAW" to "Strohhalm", "PLASTIC_UTENSIL" to "Plastikbesteck", "SIX_PACK_RING" to "Dosenring", "PLASTIC_SHEETING" to "Plastikfolie", "DIAPER" to "Windel", "CIGARETTE_BUTT" to "Zigarettenstummel", "CIGARETTE_LIGHTER" to "Feuerzeug", "FISHING_LINE" to "Angelschnur", "ROPE" to "Seil", "FISHING_BUOY" to "Fischerboje", "FISHING_TRAP" to "Fischreuse", "AEROSOL_CAN" to "Spraydose", "METAL_DRUM" to "Metallfass", "WIRE_CABLE" to "Draht/Kabel", "BATTERY" to "Batterie", "ELECTRONICS" to "Elektronik", "GLASS_BOTTLE" to "Glasflasche", "GLASS_JAR" to "Glasgefass", "GLASS_FRAGMENT" to "Glasscherbe", "LIGHT_BULB" to "Gluhbirne", "FLIP_FLOP" to "Badelatschen", "RUBBER_HOSE" to "Gummischlauch", "CLOTHING" to "Kleidung", "SHOE" to "Schuh", "CARDBOARD" to "Karton", "PAPER" to "Papier", "WOOD_PALLET" to "Holzpalette", "LUMBER" to "Holzbrett", "CERAMIC_FRAGMENT" to "Keramikfragment", "BRICK" to "Ziegel/Beton", "PAINT_CAN" to "Farbdose", "OIL_CONTAINER" to "Olbehalter", "SYRINGE" to "Spritze", "CHEMICAL_DRUM" to "Chemikalienfass", "FABRIC_DEBRIS" to "Textilabfall", "GLASS_DEBRIS" to "Glasabfall",
            ),
            "it" to mapOf(
                "PLASTIC_DEBRIS" to "Rifiuti plastici", "FISHING_NET" to "Rete da pesca", "TIRE" to "Pneumatico", "BOTTLE" to "Bottiglia", "CAN" to "Lattina", "MASK" to "Mascherina", "GLOVE" to "Guanto", "METAL_DEBRIS" to "Rifiuti metallici",
                "BOTTLE_CAP" to "Tappo", "PLASTIC_BAG" to "Sacchetto di plastica", "FOOD_WRAPPER" to "Involucro alimentare", "STYROFOAM" to "Polistirolo", "PLASTIC_CUP" to "Bicchiere di plastica", "STRAW" to "Cannuccia", "PLASTIC_UTENSIL" to "Posata di plastica", "SIX_PACK_RING" to "Anello portabirre", "PLASTIC_SHEETING" to "Telo di plastica", "DIAPER" to "Pannolino", "CIGARETTE_BUTT" to "Mozzicone", "CIGARETTE_LIGHTER" to "Accendino", "FISHING_LINE" to "Lenza", "ROPE" to "Corda", "FISHING_BUOY" to "Boa da pesca", "FISHING_TRAP" to "Nassa da pesca", "AEROSOL_CAN" to "Bomboletta spray", "METAL_DRUM" to "Fusto metallico", "WIRE_CABLE" to "Filo/Cavo", "BATTERY" to "Batteria", "ELECTRONICS" to "Elettronica", "GLASS_BOTTLE" to "Bottiglia di vetro", "GLASS_JAR" to "Barattolo di vetro", "GLASS_FRAGMENT" to "Frammento di vetro", "LIGHT_BULB" to "Lampadina", "FLIP_FLOP" to "Infradito", "RUBBER_HOSE" to "Tubo di gomma", "CLOTHING" to "Abbigliamento", "SHOE" to "Scarpa", "CARDBOARD" to "Cartone", "PAPER" to "Carta", "WOOD_PALLET" to "Pallet di legno", "LUMBER" to "Tavola di legno", "CERAMIC_FRAGMENT" to "Frammento ceramico", "BRICK" to "Mattone/Cemento", "PAINT_CAN" to "Barattolo di vernice", "OIL_CONTAINER" to "Tanica d'olio", "SYRINGE" to "Siringa", "CHEMICAL_DRUM" to "Fusto chimico", "FABRIC_DEBRIS" to "Rifiuti tessili", "GLASS_DEBRIS" to "Rifiuti di vetro",
            ),
            "pt" to mapOf(
                "PLASTIC_DEBRIS" to "Resíduos plásticos", "FISHING_NET" to "Rede de pesca", "TIRE" to "Pneu", "BOTTLE" to "Garrafa", "CAN" to "Lata", "MASK" to "Máscara", "GLOVE" to "Luva", "METAL_DEBRIS" to "Resíduos metálicos",
                "BOTTLE_CAP" to "Tampa", "PLASTIC_BAG" to "Saco de plastico", "FOOD_WRAPPER" to "Embalagem de comida", "STYROFOAM" to "Isopor", "PLASTIC_CUP" to "Copo de plastico", "STRAW" to "Canudo", "PLASTIC_UTENSIL" to "Talher de plastico", "SIX_PACK_RING" to "Anel de latas", "PLASTIC_SHEETING" to "Lona de plastico", "DIAPER" to "Fralda", "CIGARETTE_BUTT" to "Ponta de cigarro", "CIGARETTE_LIGHTER" to "Isqueiro", "FISHING_LINE" to "Linha de pesca", "ROPE" to "Corda", "FISHING_BUOY" to "Boia de pesca", "FISHING_TRAP" to "Armadilha de pesca", "AEROSOL_CAN" to "Aerossol", "METAL_DRUM" to "Tambor metalico", "WIRE_CABLE" to "Fio/Cabo", "BATTERY" to "Pilha", "ELECTRONICS" to "Eletronico", "GLASS_BOTTLE" to "Garrafa de vidro", "GLASS_JAR" to "Pote de vidro", "GLASS_FRAGMENT" to "Fragmento de vidro", "LIGHT_BULB" to "Lampada", "FLIP_FLOP" to "Chinelo", "RUBBER_HOSE" to "Mangueira de borracha", "CLOTHING" to "Roupa", "SHOE" to "Sapato", "CARDBOARD" to "Papelao", "PAPER" to "Papel", "WOOD_PALLET" to "Palete de madeira", "LUMBER" to "Tabua de madeira", "CERAMIC_FRAGMENT" to "Fragmento ceramico", "BRICK" to "Tijolo/Concreto", "PAINT_CAN" to "Lata de tinta", "OIL_CONTAINER" to "Recipiente de oleo", "SYRINGE" to "Seringa", "CHEMICAL_DRUM" to "Tambor quimico", "FABRIC_DEBRIS" to "Residuos texteis", "GLASS_DEBRIS" to "Residuos de vidro",
            ),
        )
